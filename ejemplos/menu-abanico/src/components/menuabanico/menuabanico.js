...
// Path relativo
let childLinksTo = ['/pencil', '/at', '/camera', '/bell', '/comment', '/bolt', '/ban', '/code'];
...
class MenuAbanico extends React.Component {
  constructor(props) {
    super(props);
